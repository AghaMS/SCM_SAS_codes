...
set Depot={'CDC','ID1','ID2','ID3'};
set IntermediateDepot={'ID1','ID2','ID3'};
set PointDelivery={'Home','PhysStore','Amazon','Library','GasKiosk'};

number Depot_Capacity{Depot}=[99999 20000 7000 10000];
number Depot_Handling{Depot}=[0 2 1.80 1.45];
number ID_Transport{IntermediateDepot}=[3 2.5 2.44];
number ID_FixedCost{IntermediateDepot}=[1300 1050 1000];
number POD_Transport{Depot,PointDelivery}=[
 7.50 4.56 6.32 7.85 6.20
 2.40 3.10 9999 9999 9999
 9999 9999 1.23 3.56 1.10
 9999 9999 1.02 3.30 1.05 
];
...
con Pmax: sum{k in IntermediateDepot}Use_ID[k]<=3;
